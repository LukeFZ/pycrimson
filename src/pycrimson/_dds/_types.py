...
from bier.serialization import BinarySerializable, u32, custom, static_length


class DXGI_FORMAT(u32, Enum):
...
class DDS_PIXELFORMAT(BinarySerializable):
    size: u32
    flags: u32
    four_cc: custom[bytes, static_length[4]]
    rgb_bit_count: u32
    r_bit_mask: u32
    g_bit_mask: u32
    b_bit_mask: u32
...
@dataclass(frozen=True)
class DDS_HEADER(BinarySerializable):
    size: u32
    flags: u32
    height: u32
    width: u32
    ...
    depth: u32
    mip_map_count: u32
    reserved1: custom[list[u32], static_length[11]]
...
@dataclass(frozen=True)
class DDS_HEADER_DXT10(BinarySerializable):
    format: DXGI_FORMAT
